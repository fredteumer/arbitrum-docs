...
AEP_FEES = [
  ...
  (L1BaseFee * Daily_price_L1_gas_token_to_ETH) +
...
L1BaseFee + L1SurplusFee: Retrieved from the SequencerInbox on the parent chain by summing the actual gas costs of batch-posting transactions (denominated in ETH).
